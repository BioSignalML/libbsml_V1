...
Recording *HDF5Recording_init(const char *, char, const char *, dict *) ;
void HDF5Recording_close(Recording *) ;
Recording *HDF5Recording_open(const char *, char, const char *) ;
Recording *HDF5Recording_create(const char *, char, const char *, dict *) ;
...
Signal **HDF5Recording_create_signal_group(Recording *, char **, double **, int, dict *) ;
void HDF5Recording_append_signal_data(Recording *, double **, int) ;

void HDF5Recording_save_metadata(Recording *, const char *, dict *) ;


Signal *HDF5Signal_init(const char *, Recording *, hid_t, dict *, int) ;
void HDF5Signal_close(Signal *s) ;
Signal *HDF5Signal_open(const char *, Recording *r) ;
Signal *HDF5Signal_create(const char *, Recording *, TimeSeries *, dict *) ;
